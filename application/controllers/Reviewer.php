...
class Reviewer extends Operator_Controller
{
    ...
    public function search($page = null)
    {
        ...
        $reviewers  = $this->reviewer->like('reviewer_nip', $keywords)->orLike('reviewer_name', $keywords)->orLike('faculty_name', $keywords)->orLike('reviewer_expert', $keywords)->orLike('username', $keywords)->join('faculty')->join('user')->orderBy('faculty.faculty_id')->orderBy('reviewer_name')->paginate($page)->getAll();
        $tot        = $this->reviewer->like('reviewer_id', $keywords)->orLike('reviewer_name', $keywords)->orLike('reviewer_expert', $keywords)->join('faculty')->orderBy('faculty.faculty_id')->orderBy('reviewer_name')->getAll();
        $total      = count($tot);
