...
class Commonlibs {
    ...
    public function insertWithMiddleTable($table_dest, $table_from, $table_middle, $data, $id_table_middle) {
    ...
    public function insertWithSingleTable($table_dest, $table_from, $id_table_from) {
    ...
    public function updateIntoDifferentTable($table_dest, $table_from, $table_middle, $data, $id_table_middle, $id_table_from) {
        ...
        if ($pk_table_id > 0) {
            ...
            $this->insertWithMiddleTable($table_dest, $table_from, $table_middle, $data, $id_table_middle);
        }
