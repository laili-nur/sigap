    ...
    <section id="data-draft" class="card">
        <header class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                <li class="nav-item">
                    <a class="nav-link active show" data-toggle="tab" href="#book-data"><i
                            class="fa fa-info-circle"></i> Detail Buku</a>
                </li>
                ...
                <?php //endif; ?> -->
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#author-data"><i class="fa fa-user-tie"></i> Penulis</a>
                </li>
            </ul>
        </header>
        <div class="card-body">
            ...
            <div class="tab-content">
                <!-- book-data -->
                <div class="tab-pane fade active show" id="book-data">
                        ...
                        <table class="table table-striped table-bordered mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a
                                            href="<?= base_url('draft/view/' . $input->draft_id); ?>"><?= $input->draft_title; ?></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <?php //if ($input->from_outside == 0) : ?>
                <!-- stock-data -->
                <!-- <div class="tab-pane fade" id="stock-data">
                    <div id="reload-stock">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                ...
                                <button class="btn btn-primary btn-sm " title="Ubah Stok" class="btn btn-primary btn-sm"
                                    data-toggle="modal" data-target="#modal_add_stock">Ubah</button>
                                Modal add stock
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-left">
                                                <div class="alert alert-warning"><strong>PERHATIAN!</strong> Fitur ini
                                                    berfungsi untuk mengubah stok buku.</div>
                                                <form action="<?//= base_url('book/add_book_stock'); ?>" method="post">
                                                    <div class="form-group">
                                                        <label class="font-weight-bold">Judul Buku</label>
                                                        <input type="text" class="form-control"
                                                            value="<?//= $input->book_title; ?>" disabled />
                                                    ...
                                                    <div class="form-group">
                                                        <label class="font-weight-bold" for="date">Tanggal Input<abbr
                                                                title="Required">*</abbr></label>
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Apakah anda yakin akan menghapus data stok buku dari buku
                                                                <span
                                                                    class="font-weight-bold"><?//= $input->book_title; ?></span>
                ...
                <!-- author-data -->
                <div class="tab-pane fade" id="author-data">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle"><a
                                                href="<?= base_url('author/view/profile/' . $author->author_id); ?>"><?= $author->author_name; ?></a>
                                        </td>
