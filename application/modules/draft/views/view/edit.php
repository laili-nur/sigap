        ...
        <div class="d-flex align-items-center">
            ...
            <div class="card-header-control">
                <?php if ($ceklevel == 'superadmin' || $ceklevel == 'admin_penerbitan') : ?>
                    ...
                    <button
                        type="button"
                        class="d-inline btn <?= ($editors == null) ? 'btn-warning' : 'btn-secondary'; ?>"
                        data-toggle="modal"
                        data-target="#piliheditor"
                        title="Pilih editor"
                    ...
                    <button
                        ...
                        data-toggle="modal"
                        data-target="#edit_deadline"
                        title="Ubah Deadline"
                    ><i class="fas fa-calendar-alt fa-fw"></i><span class="d-none d-lg-inline"> Ubah Deadline</span></button>
                <?php endif; ?>
                <?php if ($ceklevel == 'editor' or $ceklevel == 'superadmin' or $ceklevel == 'admin_penerbitan') : ?>
                    <button
                        ...
                        class="d-inline btn btn-secondary"
                        id="btn-mulai-editor"
                        <?= (($input->edit_start_date == null or $input->edit_start_date == '0000-00-00 00:00:00') and $editors) ? '' : 'disabled'; ?>
                    ><i class="fas fa-play"></i><span class="d-none d-lg-inline"> Mulai</span></button>
                    <button
                        title="Selesai proses editorial"
                        type="button"
                        class="d-inline btn btn-secondary"
                        id="btn-selesai-editor"
                        <?= ($input->edit_end_date == null or $input->edit_end_date == '0000-00-00 00:00:00' and ($input->edit_start_date != null and $input->edit_start_date != '0000-00-00 00:00:00')) ? '' : 'disabled'; ?>
    ...
    >
        ...
        <div class="list-group-item justify-content-between">
            ...
            <?php if ($input->is_edit == 'y') : ?>
                ...
                ><i class="fa fa-info-circle"></i> Editorial Selesai</a>
        ...
        <div class="el-example">
            <?php if ($ceklevel == 'superadmin' || $ceklevel == 'admin_penerbitan') : ?>
                <button
                    ...
                    data-toggle="modal"
                    data-target="#edit_aksi"
                ><i class="fa fa-thumbs-up"></i> Aksi</button>
            <?php endif; ?>
            <button
                type="button"
                class="btn <?= ($input->edit_notes != '' || $input->edit_notes_author != '') ? 'btn-success' : 'btn-outline-success'; ?>"
                data-toggle="modal"
                data-target="#edit"
                <?= ($ceklevel == 'editor' and $sisa_waktu_edit <= 0 and $input->edit_notes == '') ? 'disabled' : ''; ?>
            >Tanggapan Editorial
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php if ($ceklevel == 'editor' or ($ceklevel == 'author' and $author_order == 1) or $ceklevel == 'superadmin' or $ceklevel == 'admin_penerbitan') : ?>
                            ...
                            <!-- .form-group -->
                            <div class="form-group">
                                <label for="edit_file_link">Link Naskah</label>
                                <div>
                                    <?= form_input('edit_file_link', $input->edit_file_link, 'class="form-control naskah" id="edit_file_link"'); ?>
                                </div>
                                <?= form_error('edit_file_link'); ?>
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <button
                        ...
                        <div id="modal-edit">
                            <p>Last Upload :
                                ...
                                <br> by :
                                <?= konversi_username_level($input->edit_upload_by); ?>
                                <?php if ($ceklevel != 'author' and $ceklevel != 'reviewer') : ?>
                                    <em>(
                    <?= $input->edit_upload_by; ?>)</em>
                                <?php endif; ?>
                            </p>
                            ...
                            <?= (!empty($input->edit_file_link)) ? '<a data-toggle="tooltip" data-placement="right" title="" data-original-title="' . $input->edit_file_link . '" href="' . $input->edit_file_link . '" class="btn btn-success"><i class="fa fa-external-link-alt"></i> External file</a>' : ''; ?>
                            <?= (!empty($input->edit_file_link) or !empty($input->edit_file)) ? '<button data-toggle="tooltip" data-placement="right" title="" data-original-title="hapus file" class="btn btn-danger" id="btn-delete-edit"><i class="fa fa-trash"></i></button>' : ''; ?>
                        </div>
                        <hr class="my-3">
                        <!-- .form -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button
                            ...
                            id="mulai-revisi-editor"
                            title="Tanggal mulai revisi dan status draft akan tersimpan"
                            data-toggle="tooltip"
                                                ...
                                                <tr>
                                                    ...
                                                    >
                                                        <button
                                                            ...
                                                            title="Hapus"
                                                            href="javascript"
                                                            class="btn btn-sm btn-danger delete-editor"
