                        ...
                        <table class="table table-striped table-bordered mb-0 nowrap">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($pData->print_type == 0) {
                                            echo 'POD';
                                        } elseif ($pData->print_type == 1) {
                                            echo 'Offset';
                                        } else {
                                            echo '';
                                        }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($pData->print_category == 0) {
                                            echo 'Cetak baru';
                                        } elseif ($pData->print_category == 1) {
                                            echo 'Cetak ulang';
                                        } else {
                                            echo '';
                                        }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($pData->print_priority == 0) {
                                            echo 'Rendah';
                                        } elseif ($pData->print_priority == 1) {
                                            echo 'Sedang';
                                        } elseif ($pData->print_priority == 2) {
                                            echo 'Tinggi';
                                        } else {
                                            echo '';
                                        }
                                ...
                                <tr>
                                    ...
                                    <td><?php if (empty($pData->entry_date) == FALSE) {
                                            echo date('d F Y H:i:s', strtotime($pData->entry_date));
                                        } ?></td>
                                </tr>
                                <tr>
                                    <td width="140px">Tanggal selesai</td>
                                    <td><?php if (empty($pData->finish_date) == FALSE) {
                                            echo date('d F Y H:i:s', strtotime($pData->finish_date));
                                        } ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($pData->progress_status == 0) {
                                            echo 'Belum di proses.';
                                        } elseif ($pData->progress_status == 1) {
                                            echo 'Proses Pracetak';
                                        } elseif ($pData->progress_status == 2) {
                                            echo 'Proses Cetak';
                                        } elseif ($pData->progress_status == 3) {
                                            echo 'Proses Jilid';
                                        } elseif ($pData->progress_status == 4) {
                                            echo 'Proses Final';
                                        } elseif ($pData->progress_status == 5) {
                                            echo 'Ditolak';
                                        } elseif ($pData->progress_status == 6) {
                                            echo 'Selesai';
                                        } else {
                                            echo '';
                                        }
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            ...
                                            href="<?= base_url("book/download_file/bookfile/$book->book_file"); ?>"
                                            data-original-title="<?= $book->book_file; ?>"
                                        ><i class="fa fa-book"></i> File Buku</a>
                                        <a
                                            data-toggle="tooltip"
                                            data-placement="right"
                                            title=""
...
?>
    <section id="section_final">
        <div>Order cetak telah selesai. Anda bisa melihat stok buku di sini :<br><span><a
                    href="<?= base_url('book/view/' . $pData->book_id); ?>"
                    target="_blank"
                ><i class="fa fa-external-link-alt"></i> Link buku</a></span>
        </div>
    </section>
<?php
}
