                ...
                <div class="col-md-5">
                    <div class="well">
                        ...
                        >
                            ...
                            >
                                <button
                                    class="btn btn-danger btn-migrate"
                                    data-version="0"
                                    autocomplete="off"
                                >
                                    Reset
                            ...
                            <tr<?= $migration['version'] != $current_version ? '' : ' class="success"' ?>>
                                ...
                                <td>
                                    <button
                                        ...
                                        class="btn btn-sm btn-primary btn-migrate btn-block"
                                        autocomplete="off"
                                    >
                                        Migrate
                                    </button>
    ...
    $(document).ready(function() {
        ...
        btn_migrate.click(function() {
            ...
            $.when($.ajax("<?= site_url('migrate/token') ?>", {
                cache: false,
                error: function() {
                    msg('#msg-migrate', 'danger', {
                        content: 'CSRF Token could not be get.'
                    });
                }
            })).done(function(t) {
                console.log(t);
