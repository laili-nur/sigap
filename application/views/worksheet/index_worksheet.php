...
$worksheet_status_badge = [
    0 => '<span class="badge badge-warning">Waiting</span>',
               ...
               <div class="p-3">
                  ...
                  >
                     ...
                     <p class="m-0">Klik tombol <button class="btn btn-sm btn-secondary"><i class="fa fa-thumbs-up"></i>
                           Aksi</button> untuk menyetujui atau menolak draft sesuai dengan keputusan desk screening</p>
                     <p class="m-0">Klik link di kolom <em>Judul draft</em> untuk menuju draft yang terkait</p>
                     <p class="m-0">Klik link di kolom <em>Nomer lembar kerja</em> untuk memasukkan keterangan desk
                        screening</p>
                     <button
                        type="button"
                        class="close"
                  ...
                  <table class="table table-striped">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="align-middle"><?=$worksheet_status_badge[$worksheet->worksheet_status];?> </td>
