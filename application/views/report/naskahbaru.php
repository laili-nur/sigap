...
<form action="">
  <a href="<?=base_url('draft/filter?reprint=n&filter=review') ?>" target="_blank" class="badge badge-primary">Review</a>
  <a href="<?=base_url('draft/filter?reprint=n&filter=edit') ?>" target="_blank" class="badge badge-primary">Editorial</a>
  <a href="<?=base_url('draft/filter?reprint=n&filter=layout') ?>" target="_blank" class="badge badge-primary">Layout</a>
  <a href="<?=base_url('draft/filter?reprint=n&filter=proofread') ?>" target="_blank" class="badge badge-primary">Proofread</a>
  <a href="<?=base_url('draft/filter?reprint=n&filter=cetak') ?>" target="_blank" class="badge badge-primary">Cetak</a>
  <a href="<?=base_url('draft/filter?reprint=n&filter=final') ?>" target="_blank" class="badge badge-primary">Final</a>
</form>
