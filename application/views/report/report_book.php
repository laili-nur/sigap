...
<?= form_open('', ['method' => 'GET']) ?>
          <div class="form-group row">
            ...
            <div class="col-4 col-md-2  mb-4">
              <?= form_dropdown('droptahunbuku', getYearsSummary(), $this->input->get('droptahunbuku'), 'onchange="this.form.submit()" id="droptahunbuku" class="form-control custom-select d-block" title="Filter tahun"') ?>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-8 col-md-10 mb-1">
...
$.post("<?php echo base_url();?>Reporting/getBook?droptahunbuku="+tahun+"&category="+category,
function(data){
