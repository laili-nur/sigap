...
$draft->review_flag                 = true;?>
                  ...
                  <td class="align-middle text-right">
                    ...
                    <button title="Delete" type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-hapus-<?=$draft->draft_id;?>"><i
                        class="fa fa-trash-alt"></i><span class="sr-only">Delete</span></button>
                    <div class="text-left">
                      <!-- Alert Danger Modal -->
                      <div class="modal modal-alert fade" id="modal-hapus-<?=$draft->draft_id;?>" tabindex="-1" role="dialog"
