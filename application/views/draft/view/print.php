            ...
            <div class="card-header-control">
                <?php if ($ceklevel == 'superadmin' or $ceklevel == 'admin_penerbitan') : ?>
                    <button
                        ...
                        id="btn-mulai-cetak"
                        <?= ($input->print_start_date == null or $input->print_start_date == '0000-00-00 00:00:00') ? '' : 'disabled'; ?>
    ...
    >
        ...
        <div class="list-group-item justify-content-between">
            ...
            <?php if ($input->is_print == 'y') : ?>
                ...
                ><i class="fa fa-info-circle"></i> Cetak Selesai</a>
            <?php elseif ($input->is_print == 'n' and $input->draft_status == 99) : ?>
                <a
                    href="#"
                    onclick="event.preventDefault()"
                    class="font-weight-bold"
                ...
                >
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <hr class="my-3">
                            <!-- .form -->
                            <?= form_open('draft/api_update_draft/' . $input->draft_id, 'id="formprint"'); ?>
                            <!-- .fieldset -->
                            <fieldset>
                                <!-- .form-group -->
                                <div class="form-group">
                                        ...
                                        >
                                            <label class="btn btn-secondary <?= ($input->printing_type == 'p') ? 'active' : ''; ?>">
                                                <?= form_radio(
                                                  ...
                                                  'required class="custom-control-input" id="blocked1"'
                                                ); ?> POD</label>
                                            <label class="btn btn-secondary <?= ($input->printing_type == 'o') ? 'active' : ''; ?>">
                                                <?= form_radio(
                                                  ...
                                                  ' class="custom-control-input" id="blocked2"'
                                                ); ?> Offset</label>
                                        </div>
                                        <!-- /button radio -->
                                    </div>
