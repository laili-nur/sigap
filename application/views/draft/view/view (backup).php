...
<div class="page-section">
  ...
  <div class="alert alert-warning">
    ...
    <p class="m-0 p-0 mt-2">
      <button class="btn btn-warning btn-xs" type="button" id="pil-rev"><i class="fa fa-user-graduate"></i> Pilih reviewer</button>
      <button class="btn btn-warning btn-xs" type="button" onClick="window.location.reload()"><i class="fa fa-sync"></i> Reload</button>
    </p>
  </div>
  <?php else: ?>
  ...
  <?php endif ?>
  <?php $this->load->view('draft/view/cover'); ?>
