    ...
    >
        ...
        <div class="list-group-item justify-content-between">
            ...
            <?php if ($input->is_proofread == 'y') : ?>
                ...
                ><i class="fa fa-info-circle"></i> Proofread Selesai</a>
        ...
        <div class="el-example">
            <?php if ($ceklevel == 'superadmin' || $ceklevel == 'admin_penerbitan') : ?>
                <button
                    ...
                    data-toggle="modal"
                    data-target="#proofread_aksi"
                ><i class="fa fa-thumbs-up"></i> Aksi</button>
            <?php endif; ?>
            <button
                type="button"
                class="btn <?= ($input->proofread_notes != '' || $input->proofread_notes_author != '') ? 'btn-success' : 'btn-outline-success'; ?>"
                data-toggle="modal"
                data-target="#proofread"
                id="btn-tanggapan-proofread"
            >Tanggapan Proofread
                ...
                >
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <hr class="my-3">
                            <!-- .form -->
                            <?= form_open('draft/api_update_draft/' . $input->draft_id, 'id="formproofread"'); ?>
                            <!-- .fieldset -->
                            <fieldset>
                                <!-- .form-group -->
                                <div class="form-group">
