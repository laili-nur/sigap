  ...
  <div class="list-group list-group-flush list-group-bordered" id="list-group-layout">
    ...
    <div class="list-group-item justify-content-between">
      ...
      <strong>
            <?php if ($layouters) {
              $i = 0;
              foreach ($layouters as $idx => $layouter){
                if($idx==0){
            ...
            <div id="reload-layouter">
              ...
              <div class="table-responsive">
                ...
                <table class="table table-bordered mb-0 nowrap">
                  <!-- tbody -->
                  <tbody>
                    <?php foreach($layouters as $idx => $layouter): ?>
                    <!-- tr -->
                    <tr>
                      <td class="align-middle">
                        <?= $layouter->username ?> <span style="color:blue;font-style: italic;"><?= $idx==0?'(layouter)':'(desain cover)'; ?></span>
                      </td>
