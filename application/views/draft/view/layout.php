        ...
        <div class="d-flex align-items-center">
            ...
            <div class="card-header-control">
                <?php if ($ceklevel == 'superadmin' || $ceklevel == 'admin_penerbitan') : ?>
                    ...
                    <button
                        type="button"
                        class="d-inline btn <?= ($layouters == null) ? 'btn-warning' : 'btn-secondary'; ?>"
                        data-toggle="modal"
                        data-target="#pilihlayouter"
                ...
                <?php if ($ceklevel == 'layouter' or $ceklevel == 'superadmin' or $ceklevel == 'admin_penerbitan') : ?>
                    <button
                        title="Mulai proses layout"
                        type="button"
                        class="d-inline btn btn-secondary"
                        id="btn-mulai-layouter"
                        <?= (($input->layout_start_date == null or $input->layout_start_date == '0000-00-00 00:00:00') and $layouters) ? '' : 'disabled'; ?>
                    ><i class="fas fa-play"></i><span class="d-none d-lg-inline"> Mulai</span></button>
                    <button
                        title="Mulai proses layout"
                        type="button"
                        class="d-inline btn btn-secondary"
                        id="btn-selesai-layouter"
                        <?= ($input->layout_end_date == null or $input->layout_end_date == '0000-00-00 00:00:00' and ($input->layout_start_date != null and $input->layout_start_date != '0000-00-00 00:00:00')) ? '' : 'disabled'; ?>
    ...
    >
        ...
        <div class="list-group-item justify-content-between">
            ...
            <?php if ($input->is_layout == 'y') : ?>
                ...
                ><i class="fa fa-info-circle"></i> Layout Selesai</a>
        ...
        <div class="el-example">
            <?php if ($ceklevel == 'superadmin' || $ceklevel == 'admin_penerbitan') : ?>
                <button
                    ...
                    data-toggle="modal"
                    data-target="#layout_aksi"
                ><i class="fa fa-thumbs-up"></i> Aksi</button>
            <?php endif; ?>
            <button
                type="button"
                class="btn <?= ($input->layout_notes != '' || $input->layout_notes_author != '') ? 'btn-success' : 'btn-outline-success'; ?>"
                data-toggle="modal"
                data-target="#layout"
                <?= ($ceklevel == 'layouter' and $sisa_waktu_layout <= 0 and $input->layout_notes == '') ? 'disabled' : ''; ?>
            >Tanggapan Layout
                <?= ($input->layout_notes != '' || $input->layout_notes_author != '') ? '<i class="fa fa-check"></i>' : ''; ?></button>
            <button
                type="button"
                class="btn <?= ($input->cover_notes != '' || $input->cover_notes_author != '') ? 'btn-success' : 'btn-outline-success'; ?>"
                data-toggle="modal"
                data-target="#cover"
                <?= ($ceklevel == 'layouter' and $sisa_waktu_layout <= 0 and $input->layout_notes == '') ? 'disabled' : ''; ?>
            >Tanggapan Cover
            ...
            >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <hr class="my-3">
                        <!-- .form -->
                        <?= form_open('draft/api_update_draft/' . $input->draft_id, 'id="formlayout"'); ?>
                        <!-- .fieldset -->
                        <fieldset>
                            <!-- .form-group -->
                            <div class="form-group">
            ...
            >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                            ...
                                            <section class="card card-figure">
                                                ...
                                                <figure class="figure">
                                                    ...
                                                    <div class="figure-img">
                                                        <img
                                                            class="img-fluid"
                                                            src="<?= base_url('coverfile/' . $input->cover_file); ?>"
                                                            alt="Card image cap"
                                                        >
                                                        <div class="figure-action">
                                                            <a
                                                                href="<?= base_url('draft/download/coverfile/' . urlencode($input->cover_file)); ?>"
                        ...
                        <hr class="my-3">
                        <!-- .form -->
                        <?= form_open('draft/api_update_draft/' . $input->draft_id, 'id="formcover"'); ?>
                        <!-- .fieldset -->
                        <fieldset>
                            <!-- .form-group -->
                            <div class="form-group">
                                                ...
                                                <tr>
                                                    ...
                                                    >
                                                        <button
                                                            ...
                                                            title="Hapus"
                                                            href="javascript"
                                                            class="btn btn-sm btn-danger delete-layouter"
