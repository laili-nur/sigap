...
>
    <div id="review-progress">
        ...
        <div class="card-body">
            ...
            <button
                type="button"
                class="btn-modal-review btn <?= ($input->review1_notes != '' || $input->review1_notes_author != '') ? 'btn-success' : 'btn-outline-success'; ?> <?= !$is_review_started ? 'btn-disabled' : ''; ?>"
                data-toggle="modal"
            ...
            <button
                type="button"
                class="btn-modal-review btn <?= ($input->review2_notes != '' || $input->review2_notes_author != '') ? 'btn-success' : 'btn-outline-success'; ?> <?= !$is_review_started ? 'btn-disabled' : ''; ?>"
                data-toggle="modal"
                data-target="#modal-review"
                data-identifier="review2"
                <?= !$is_review_started ? 'disabled' : ''; ?>
