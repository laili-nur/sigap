    ...
    foreach ($performance_layouter as $row) {
        ?>
            <tr>
              ...
              <td><?php echo format_datetime($row->layout_start_date); ?></td>
              <td><?php echo format_datetime($row->layout_deadline); ?></td>
              <td><?php echo format_datetime($row->layout_end_date); ?></td>
              <td><?php
