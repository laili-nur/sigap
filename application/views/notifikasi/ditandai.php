...
<header class="page-title-bar">
  ...
  <h1 class="page-title"> Notifikasi Ditandai</h1>
</header>
<!-- /.page-title-bar -->
<!-- .page-section -->
      ...
      <section class="card card-fluid">
        ...
        <div class="card-body p-0">
          <div class="p-3">
            ...
            <div class="row">
              <div class="col-12">
                <?= form_open('notifikasi/searchs_ditandai', ['method' => 'GET']) ?>
                              ...
                              <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" onclick="location.href='<?= base_url('notifikasi/tandai_hapus/' . $notif->id . '/ditandai') ?>'"
