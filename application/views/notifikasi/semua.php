      ...
      <section class="card card-fluid">
        ...
        <div class="card-body p-0">
          <div class="p-3">
            ...
            <div class="row">
              <div class="col-12">
                <?= form_open('notifikasi/searchs_semua', ['method' => 'GET']) ?>
          ...
          <div class="double-scroll">
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <!-- tr -->
                <tr class="belum-dibaca" <?php echo $notif->is_mark==1?'style="color: #346CB0;font-weight:bold;"':'style="color: #000;"'; ?>>
                  <td class="align-middle pl-3">
                    <a href="<?php echo site_url('draft/view/'.$notif->draft_id); ?>" style="color: inherit;"><?= ++$i ?></a>
                  </td>
                  <td class="align-middle">
                    <a href="<?php echo site_url('draft/view/'.$notif->draft_id); ?>" style="color: inherit;"><?php echo date('d/m/Y H:i:s', strtotime($notif->tgl)); ?></a>
                  </td>
                  <td class="align-middle"><a href="<?php echo site_url('draft/view/'.$notif->draft_id); ?>" style="color: inherit;text-decoration: underline;"><?php echo $notif->judul; ?></a></td>
                  <td class="align-middle">
                    <a href="<?php echo site_url('draft/view/'.$notif->draft_id); ?>" style="color: inherit;"><?php echo $notif->isi; ?></a>
                  </td>
                  <td class="align-middle text-center">
                              ...
                              <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <p>Apakah anda yakin akan menghilangkan tanda notifikasi?</p>
                                  </div>
                                  <!-- /.modal-body -->
                                  <!-- .modal-footer -->
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" onclick="location.href='<?= base_url('notifikasi/tandai_hapus/' . $notif->id . '/semua') ?>'"
                                      data-dismiss="modal">Hapus Tandai</button>
                    ...
                    <?php }else{ ?>
                        <a title="Tandai" href="<?= base_url('notifikasi/tandai/'.$notif->id.'/semua') ?>" class="btn btn-sm btn-secondary">
