...
<header class="page-title-bar">
  ...
  <h1 class="page-title"> Notifikasi Belum Dibaca</h1>
</header>
<!-- /.page-title-bar -->
<!-- .page-section -->
      ...
      <section class="card card-fluid">
        ...
        <div class="card-body p-0">
          <div class="p-3">
            ...
            <div class="row">
              <div class="col-12">
                <?= form_open('notifikasi/searchs_belum_dibaca', ['method' => 'GET']) ?>
              ...
              <tbody>
                ...
                <tr class="belum-dibaca" <?php echo $notif->is_mark==1?'style="color: #346CB0;font-weight:bold;"':'style="color: #000;"'; ?>>
                  ...
                  <td class="align-middle text-center">
                              ...
                              <div class="modal-dialog" role="document">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-danger" onclick="location.href='<?= base_url('notifikasi/tandai_hapus/' . $notif->id . '/belum_dibaca') ?>'"
                    ...
                    <?php }else{ ?>
                        <a title="Tandai" href="<?= base_url('notifikasi/tandai/'.$notif->id.'/ditandai') ?>" class="btn btn-sm btn-secondary">
