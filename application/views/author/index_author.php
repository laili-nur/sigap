              ...
              <table class="table table-striped">
                ...
                <thead>
                  <tr>
                    ...
                    <th scope="col" style="min-width:100px;">Unit Kerja</th>
                    <th scope="col" style="min-width:100px;">Institusi</th>
                  ...
                  <?php foreach ($authors as $author): ?>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-right">
                        ...
                        <button title="Delete" type="button" class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#modal-hapus-<?=$author->author_id;?>"><i class="fa fa-trash-alt"></i><span class="sr-only">Delete</span></button>
                        <div class="text-left">
                          <!-- Alert Danger Modal -->
                          <div class="modal modal-alert fade" id="modal-hapus-<?=$author->author_id;?>" tabindex="-1" role="dialog" aria-labelledby="modal-hapus" aria-hidden="true">
                            <!-- .modal-dialog -->
