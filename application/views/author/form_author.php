         ...
         <section class="card">
            <div class="card-body">
               ...
               <fieldset>
                  ...
                  <div class="form-group">
                     <label for="author_latest_education"><?= $this->lang->line('form_author_latest_education'); ?></label>
                  ...
                  <div class="form-group">
                     ...
                     <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="author_ktp">Pilih file</label>
                     </div>
                     ...
                     <?php if ($input->author_ktp) : ?>
                        <div class="mt-3">
                           <?php if (in_array(check_file_extension($input->author_ktp), ['jpg', 'png', 'jpeg'])) : ?>
                              <img class="uploaded-file" src="<?= base_url("author/view_image/authorktp/$input->author_ktp"); ?>" width="100%">
                           <?php endif; ?>
                           <a href="<?= base_url("author/download_file/authorktp/$input->author_ktp"); ?>" class="btn btn-success btn-sm my-2 uploaded-file"><i class="fa fa-download"></i> Download</a>
                        </div>
                     <?php endif; ?>

                     <!-- temp image placeholder -->
                     <img width="50%" id="temp-image" />
                  </div>
               </fieldset>
               <hr>
