        ...
        <div class="card-body p-0">
          ...
          <div class="tab-pane fade active show" id="card-tabel1">
            ...
            <div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col-auto">
                        ...
                        <button title="Hapus" type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#modal-hapus-<?=$document->document_id;?>"><i class="fa fa-trash-alt"></i><span class="sr-only">Delete</span></button>
                      </div><!-- /grid column -->
                    </div><!-- /grid row -->
                  </div><!-- /.card-body -->
                </div><!-- /.card -->
              ...
              <!-- Alert Danger Modal -->
              <div class="modal modal-alert fade" id="modal-hapus-<?=$document->document_id;?>" tabindex="-1" role="dialog" aria-labelledby="modal-hapus" aria-hidden="true">
                <!-- .modal-dialog -->
